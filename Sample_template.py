...
def create_sample_template():
    ...
    rows = [
        ...
        # ["", "5. Target TPH is to be provided for the transactions which are to be included in PasFail Sheet", "", "", "", ""]
        ["", "", "", "", "", ""], 
    ]
    ...
    for row in ['A25','B25','B26','B27','B28']:
        worksheet[row].font = Font(bold=True)
